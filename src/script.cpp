...
class CKeyStoreIsMineClusteror : public boost::static_visitor<bool>
{
private:
    const CKeyStore *keystore;
public:
    CKeyStoreIsMineClusteror(const CKeyStore *keystoreIn) : keystore(keystoreIn) { }
...
{
    return boost::apply_visitor(CKeyStoreIsMineClusteror(&keystore), dest);
}
...
class CAffectedKeysClusteror : public boost::static_visitor<void> {
private:
    const CKeyStore &keystore;
    std::vector<CKeyID> &vKeys;

public:
    CAffectedKeysClusteror(const CKeyStore &keystoreIn, std::vector<CKeyID> &vKeysIn) : keystore(keystoreIn), vKeys(vKeysIn) {}
...
void ExtractAffectedKeys(const CKeyStore &keystore, const CScript& scriptPubKey, std::vector<CKeyID> &vKeys) {
    CAffectedKeysClusteror(keystore, vKeys).Process(scriptPubKey);
}
...
class CScriptClusteror : public boost::static_visitor<bool>
{
private:
    CScript *script;
public:
    CScriptClusteror(CScript *scriptin) { script = scriptin; }
...
{
    boost::apply_visitor(CScriptClusteror(this), dest);
}
