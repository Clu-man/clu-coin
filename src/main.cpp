...
#if defined(NDEBUG)
# error "Clucoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Clucoin Signed Message:\n";
...
{
  int64_t nSubsidyFixed = 10000 * COIN;

  nSubsidyFixed >>= (pindexBest->nHeight / 525600);

  int64_t nSubsidy = nSubsidyFixed + nCoinAge * COIN_YEAR_REWARD * 333 / (365 * 33 + 8);
